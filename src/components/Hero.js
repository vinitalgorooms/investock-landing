...
const Hero = () => {
    return (
        <section className="from-white to-[#f3f6fd] mt-16 pt-16 md:pt-24 pb-20 md:pb-32 px-4 md:px-20 text-center overflow-hidden">
            {/* Headings */}
            <h1 className="mt-6 text-[26px] sm:text-4xl md:text-5xl font-bold leading-[1.3] md:leading-tight mb-3 sm:mb-4 
               bg-gradient-to-br from-[#0081F1] to-[#6368FA] bg-clip-text text-transparent">
            ...
            {/* Hero Image */}
            <div className="w-full flex justify-center md:-mt-56" >
                <img
                    src="/hero-app-mock.png"
                    alt="Investock App Preview"
                    className="w-full  sm:max-w-[600px] md:max-w-[90%] lg:max-w-[1200px] xl:max-w-[1400px] h-auto object-contain"
                />
            </div>
        </section>
    );
